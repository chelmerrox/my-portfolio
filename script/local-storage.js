// Variable declarations
  ...
  let nameValueMobile1, emailValueMobile1, commentValueMobile1;
  let nameValueDesktop1, emailValueDesktop1, commentValueDesktop1;
  ...
  nameMobile.addEventListener('change', (e) => {
  ...
  emailMobile.addEventListener('change', (e) => {
  ...
  commentMobile.addEventListener('change', (e) => {
  ...
  nameDesktop.addEventListener('change', (e) => {
    // Accessing the name's value
  ...
  emailDesktop.addEventListener('change', (e) => {
    // Accessing the email's value
  ...
  commentDesktop.addEventListener('change', (e) => {
    // Accessing the comment's value
